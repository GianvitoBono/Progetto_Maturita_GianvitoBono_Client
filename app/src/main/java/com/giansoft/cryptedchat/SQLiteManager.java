...
public class SQLiteManager {
    ...
    public ArrayList<Contact> getUsers() {
        try {
            ...
            Cursor c = sqLiteHelper.getReadableDatabase().rawQuery("SELECT name, surname, username FROM users", null);
            if (c.moveToFirst()) {
                do {
                    ...
                    String username = Crypter.decrypt(c.getString(c.getColumnIndex("username")));
